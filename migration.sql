...
ALTER INDEX banking_stage_results_2.transactions_pkey SET (FILLFACTOR=80);
ALTER INDEX banking_stage_results_2.transactions_signature_transaction_id_key SET (FILLFACTOR=80);
